...
const checkAnswer = el =>{
    ...
    const  showElementHud= () => {
        playButton1.style.backgroundImage = 'url(/audio/play.png)';
...
const answerTracker = () =>{
    questions.forEach(() =>{
        ...
        answersTracker.appendChild(div).classList.add('mudak');
    })
};
...
const validate = () =>{
    if (FlagNext === true){
        ...
        Payse1();
        HideAndSeek();
        hiddenavatar.style.backgroundImage = 'url(/img/whatarapper.png)';
        ...
        alert('Пожалуйста, ответьте на вопрос правильно прежде чем перейти на следующий уровень.')
    }
};
...
const playOrPayse1 = () => {
    if (!audioPlay1.paused && !audioPlay1.ensed) {
      ...
      playButton1.style.backgroundImage = 'url(/audio/pause.png)';
...
const muteOrspeaker1 = () => {
    if (audioPlay1.muted === true) {
      ...
      muteButton1.style.backgroundImage = 'url(/audio/speaker.png)';
    }else{
      audioPlay1.muted = true
      muteButton1.style.backgroundImage = 'url(/audio/mute.png)';
    }
  }
